...
public class Register_Controller_pat extends HttpServlet {
	...
	RequestDispatcher successCaseDispatcher = request.getRequestDispatcher("../profile_patient.jsp");
     ...
     errormsg +=  " Δεν έχετε συμπληρώσει το πεδίο Ημερομηνία Γέννησης<br>";
  	   ...
  	   if(address.matches("/^[Ά-ώ]+\\s\\d+\\s[Ά-ώ]/")) {

  			errormsg +=  " Τα στοιχεία που εισάγατε στο πεδίο Διεύθυνση δεν είναι έγκυρα<br>";
  		}

  		if(address == null || address.length() == 0) {

  			errormsg +=  " Δεν έχετε συμπληρώσει το πεδίο Διεύθυνση<br>";
